  ...
  const renderContent = () => {
    switch (activeTab) {
        ...
        return <section className="py-20 px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                return <div key={index} className="group p-6 rounded-2xl bg-white border border-gray-100 hover:border-[#E7BA40] hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {steps.map((step, index) => <div key={index} className="relative text-center group">
                    {index < steps.length - 1 && <div className="hidden md:block absolute top-16 left-full w-full h-0.5 bg-[#E7BA40] transform translate-x-4 z-0"></div>}
      ...
      case 'testimonials':
        return <section className="py-20 px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {testimonials.map((testimonial, index) => <div key={index} className="bg-white p-6 rounded-2xl hover:shadow-lg transition-shadow duration-300 border border-gray-100">
      ...
      default:
        return <>
            {/* Hero Section */}
            <section className="bg-[#E7BA40] py-20 px-4">

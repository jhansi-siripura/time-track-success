...
const LandingPage = () => {
  ...
  const steps = [
    { number: '01', title: 'Log Sessions', description: 'Record your study sessions with subject, duration, and notes' },
    { number: '02', title: 'Track Progress', description: 'View analytics and insights about your study patterns' },
    { number: '03', title: 'Achieve Goals', description: 'Set targets and celebrate your learning milestones' }
  ];

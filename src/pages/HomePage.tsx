...
const HomePage = () => {
  const navigationCards = [
    ...
    },
    {
      ...
      bgColor: 'bg-gradient-to-br from-red-50/80 to-red-100/50',
    ...
    },
    {
      ...
      bgColor: 'bg-gradient-to-br from-green-50/80 to-green-100/50',
    ...
    },
    {
      ...
      bgColor: 'bg-gradient-to-br from-indigo-50/80 to-indigo-100/50',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50/50 via-cream-50/30 to-yellow-50/40">
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Hero Section */}
        <div className="text-center mb-12 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-amber-200/10 to-yellow-200/10 rounded-3xl blur-3xl"></div>
          <div className="relative">
            <div className="flex items-center justify-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-2xl flex items-center justify-center shadow-lg mr-4">
              ...
              <div className="text-left">
                ...
                <p className="text-amber-700/80 font-medium">Your Learning Companion</p>
              </div>
            </div>
          ...
          {navigationCards.map((card) => {
            ...
            return (
              <Link key={card.path} to={card.path} className="group">
                <Card className={`${card.bgColor} ${card.borderColor} border-2 hover:shadow-xl hover:shadow-${card.gradient.split('-')[1]}-200/30 transition-all duration-300 transform hover:scale-105 cursor-pointer h-full relative overflow-hidden backdrop-blur-sm`}>
        ...
        <div className="text-center">
          <Card className="bg-gradient-to-br from-amber-100/80 to-yellow-100/60 border-2 border-amber-200/50 shadow-xl shadow-amber-200/20 max-w-4xl mx-auto backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link 
                  to="/add-session"
                  className="inline-flex items-center justify-center space-x-3 bg-gradient-to-r from-amber-600 to-yellow-600 text-white px-8 py-4 rounded-xl hover:from-amber-700 hover:to-yellow-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                >

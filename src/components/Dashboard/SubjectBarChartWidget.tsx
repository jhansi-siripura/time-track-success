...
const SubjectBarChartWidget = ({ data }: SubjectBarChartWidgetProps) => {
  ...
  const topicColors = ['#8884d8', '#82ca9d', '#ffc658', '#ff7c7c', '#8dd1e1', '#d084d0', '#ffb347', '#87ceeb', '#dda0dd', '#98fb98', '#ffa07a', '#20b2aa', '#778899', '#b0c4de', '#ffb6c1', '#daa520', '#cd853f', '#5f9ea0', '#7b68ee', '#6b8e23'];

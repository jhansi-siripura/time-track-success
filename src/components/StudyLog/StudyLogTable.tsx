            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="w-32 max-w-100">Achievements</TableHead>
              ...
              <TableBody>
                {studyLogs.map((log) => (
                  <TableRow key={log.id}>
                    ...
                    <TableCell className="w-28 truncate">{log.topic || '-'}</TableCell>
                    <TableCell className="w-28 truncate">{log.source || '-'}</TableCell>
                    <TableCell className="w-32 max-w-100 truncate">{log.achievements}</TableCell>

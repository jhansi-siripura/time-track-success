  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={handleModalOpenChange}>
        <DialogContent className="relative max-w-4xl max-h-[90vh] overflow-auto bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
          {/* Subject Color Bar */}
          <div
            className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${getSubjectColor(
              log.subject
            )} rounded-t-lg`}
          />
          ...
          {hasPrevious && onPrevious && (
            <Button
              ...
              size="sm"
              onClick={onPrevious}
              className="absolute left-[-36px] top-1/2 -translate-y-1/2 z-20 h-10 w-10 p-0 bg-white/80 hover:bg-white/90 shadow-md rounded-full"
              aria-label="Previous"
            >
          ...
          {hasNext && onNext && (
            <Button
              ...
              size="sm"
              onClick={onNext}
              className="absolute right-[-36px] top-1/2 -translate-y-1/2 z-20 h-10 w-10 p-0 bg-white/80 hover:bg-white/90 shadow-md rounded-full"
              aria-label="Next"
            >
          ...
          <div className="mt-6 space-y-6 px-0">
            {isEditing ? (
              ...
              <>
                {/* Study Notes */}
                {log.notes && (
                  <div className="bg-gray-50/80 rounded-lg p-4 border border-gray-200/50 py-[16px]">
